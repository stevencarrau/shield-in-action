...
class MaskedReinforceAgent(tf_agent.TFAgent):
  """A REINFORCE Agent.
  Implements:
  ...
  def __init__(self,
               ...
               train_step_counter: Optional[tf.Variable] = None,observation_and_action_constraint_splitter: Optional[types.Splitter] = None,
    ...
    if value_network:
      value_network.create_variables(net_observation_spec)
    ...
    super(MaskedReinforceAgent, self).__init__(
        time_step_spec,
        action_spec,
        policy,
        collect_policy,
